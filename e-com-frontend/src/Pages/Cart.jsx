        ...
        <div className='border-t pt-15'>
          ...
          <div>
            {
              cartData.map((item, index) => {
                ...
                return (
                  <div key={index} className='py-4 border-t border-none text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
          ...
          <div className='flex justify-end my-20'>
              <div className='w-full sm:w[450px]'>
                ...
                <div className='w-90 ml-auto text-end'>
                  <button onClick={() => navigate('/place-order')} className='bg-black text-white text-sm my-8 px-8 py-3 cursor-pointer hover:bg-gray-900'>CHECKOUT</button>
